...
public:
    ...
    ServiceReply<Object> SandboxServiceCloseSandboxAccountSync(const std::string &account_id) const;

    ServiceReply<V1GetAccountsResponse> SandboxServiceGetSandboxAccounts() const;
    ...
    ServiceReply<V1OperationsResponse> SandboxServiceGetSandboxOperations(
        ...
        utility::datetime to, std::shared_ptr<V1OperationState> state) const;
    ...
    ServiceReply<V1OrderState> SandboxServiceGetSandboxOrderState(const std::string &account_id,
                                                                  const std::string &order_id) const;

    ServiceReply<V1GetOrdersResponse> SandboxServiceGetSandboxOrders(const std::string &account_id) const;

    ServiceReply<V1PortfolioResponse> SandboxServiceGetSandboxPortfolio(
        const std::string &account_id, std::shared_ptr<PortfolioRequestCurrencyRequest> currency) const;
    ...
    ServiceReply<V1PostOrderResponse> SandboxServicePostSandboxOrder(
        ...
        std::shared_ptr<V1OrderType> order_type) const;
    ...
    ServiceReply<V1PostOrderResponse> SandboxServiceReplaceSandboxOrder(
        ...
        int32_t nano, std::shared_ptr<V1PriceType> price_type) const;
