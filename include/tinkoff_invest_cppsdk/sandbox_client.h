...
public:
    ...
    ServiceReply<V1CancelOrderResponse> SandboxServiceCancelSandboxOrder(
        ...
        int retry_max = 0,
        std::function<void(const ServiceReply<V1CancelOrderResponse> &)> callback = nullptr) const;
    ...
    ServiceReply<Object> SandboxServiceCloseSandboxAccountSync(
        ...
        std::function<void(const ServiceReply<Object> &)> callback = nullptr) const;

    ServiceReply<V1GetAccountsResponse> SandboxServiceGetSandboxAccounts(
        bool is_async_req = true, int retry_max = 0,
        std::function<void(const ServiceReply<V1GetAccountsResponse> &)> callback = nullptr) const;
    ...
    ServiceReply<V1OperationsResponse> SandboxServiceGetSandboxOperations(
        ...
        int retry_max = 0,
        std::function<void(const ServiceReply<V1OperationsResponse> &)> callback = nullptr) const;
    ...
    ServiceReply<V1OrderState> SandboxServiceGetSandboxOrderState(
        const std::string &account_id, const std::string &order_id, bool is_async_req = true,
        int retry_max = 0,
        std::function<void(const ServiceReply<V1OrderState> &)> callback = nullptr) const;

    ServiceReply<V1GetOrdersResponse> SandboxServiceGetSandboxOrders(
        const std::string &account_id, bool is_async_req = true, int retry_max = 0,
        std::function<void(const ServiceReply<V1GetOrdersResponse> &)> callback = nullptr) const;
    ...
    ServiceReply<V1PortfolioResponse> SandboxServiceGetSandboxPortfolio(
        ...
        bool is_async_req = true, int retry_max = 0,
        std::function<void(const ServiceReply<V1PortfolioResponse> &)> callback = nullptr) const;

    ServiceReply<V1PositionsResponse> SandboxServiceGetSandboxPositions(
        const std::string &account_id, bool is_async_req = true, int retry_max = 0,
        std::function<void(const ServiceReply<V1PositionsResponse> &)> callback = nullptr) const;
    ...
    ServiceReply<V1PostOrderResponse> SandboxServicePostSandboxOrder(
        ...
        std::function<void(const ServiceReply<V1PostOrderResponse> &)> callback = nullptr) const;
    ...
    ServiceReply<V1SandboxPayInResponse> SandboxServicePayIn(
        ...
        std::function<void(const ServiceReply<V1SandboxPayInResponse> &)> callback = nullptr) const;
};
