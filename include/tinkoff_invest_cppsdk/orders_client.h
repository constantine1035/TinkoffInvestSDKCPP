...
ServiceReply<V1PostOrderResponse> OrdersServiceReplaceOrder(
        ...
        std::shared_ptr<V1Quotation> price, std::shared_ptr<V1PriceType> price_type, bool is_async_req = true,
        int retry_max = 0, std::function<void(const ServiceReply<V1PostOrderResponse> &)> callback = nullptr);
};
