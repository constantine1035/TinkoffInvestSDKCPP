...
namespace TINKOFFINVESTSDKCPP_EXPORT tinkoff_invest_cppsdk {
    ...
    public:
        ...
        ServiceReply<V1PositionsResponse>
        GetPositions(std::string account_id, bool is_async_req = true, int retry_max = 0,
                     std::function<void(const ServiceReply<V1PositionsResponse> &)> callback = nullptr);

        /// Метод получения доступного остатка для вывода средств.
        ServiceReply<V1WithdrawLimitsResponse>
        GetWithdrawLimits(std::string account_id, bool is_async_req = true, int retry_max = 0,
        ...
        ServiceReply<V1BrokerReportResponse> GetBrokerReport(
                ...
                const std::shared_ptr<V1GetBrokerReportRequest> get_broker_request, bool is_async_req = true,
                int retry_max = 0,
        ...
        ServiceReply<V1GetDividendsForeignIssuerResponse> GetDividendsForeignIssuer(
                ...
                get_div_foreign_issuer_report, bool is_async_req = true, int retry_max = 0,
                std::function<void(const ServiceReply<V1GetDividendsForeignIssuerResponse> &)> callback = nullptr);
        ...
        ServiceReply<V1GetOperationsByCursorResponse> GetOperationsByCursor(
                ...
                bool without_comissions, bool without_trades, bool without_overnights, bool is_async_req = true,
                int retry_max = 0,
                std::function<void(const ServiceReply<V1GetOperationsByCursorResponse> &)> callback = nullptr);
    };
