...
InvestApiOperationsClient::InvestApiOperationsClient(const std::string &token) : InvestApiBaseClient(token) {
}

InvestApiOperationsClient::~InvestApiOperationsClient() {
}

ServiceReply<V1OperationsResponse> InvestApiOperationsClient::GetOperations(std::string account_id, int64_t fromseconds,
    ...
    return MakeRequest<ServiceId::OperationsService>(body, req);
};

ServiceReply<V1PortfolioResponse> InvestApiOperationsClient::GetPortfolio(std::string account_id,
...
ServiceReply<V1WithdrawLimitsResponse> InvestApiOperationsClient::GetWithdrawLimits(std::string account_id) {
    InitService<ServiceId::InstrumentsService, InstrumentsServiceApi>();
...
ServiceReply<V1GetDividendsForeignIssuerResponse> InvestApiOperationsClient::GetDividendsForeignIssuer(
