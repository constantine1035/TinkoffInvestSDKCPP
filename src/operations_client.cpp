...
InvestApiOperationsClient::InvestApiOperationsClient(const std::string &token, TradingMode trading_mode)
...
ServiceReply<V1OperationsResponse> InvestApiOperationsClient::GetOperations(
    ...
    const std::string &figi, const std::shared_ptr<V1OperationState> state, bool is_async_req,
    int retry_max, std::function<void(const ServiceReply<V1OperationsResponse> &)> callback) {
...
ServiceReply<V1PortfolioResponse> InvestApiOperationsClient::GetPortfolio(
    const std::string &account_id, const std::shared_ptr<PortfolioRequestCurrencyRequest> currency,
...
ServiceReply<V1PositionsResponse> InvestApiOperationsClient::GetPositions(
...
ServiceReply<V1BrokerReportResponse> InvestApiOperationsClient::GetBrokerReport(
    ...
    const std::shared_ptr<V1GetBrokerReportRequest> get_broker_request, bool is_async_req,
    int retry_max, std::function<void(const ServiceReply<V1BrokerReportResponse> &)> callback) {
...
ServiceReply<V1GetOperationsByCursorResponse> InvestApiOperationsClient::GetOperationsByCursor(
    ...
    bool without_comissions, bool without_trades, bool without_overnights, bool is_async_req,
    int retry_max,
