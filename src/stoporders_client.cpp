...
InvestApiStopOrdersClient::InvestApiStopOrdersClient(const std::string &token) : InvestApiBaseClient(token) {
}
...
ServiceReply<V1PostStopOrderResponse> InvestApiStopOrdersClient::StopOrdersServicePostStopOrder(
    ...
    std::function<pplx::task<std::shared_ptr<V1PostStopOrderResponse>>(const StopOrdersServiceApi&, std::shared_ptr<V1PostStopOrderRequest>)> req = &StopOrdersServiceApi::stopOrdersServicePostStopOrder;
    return MakeRequest<ServiceId::StopOrdersService>(body, req);
}
...
ServiceReply<V1GetStopOrdersResponse> InvestApiStopOrdersClient::StopOrdersServiceGetStopOrders(
    ...
    std::function<pplx::task<std::shared_ptr<V1GetStopOrdersResponse>>(const StopOrdersServiceApi&, std::shared_ptr<V1GetStopOrdersRequest>)> req = &StopOrdersServiceApi::stopOrdersServiceGetStopOrders;
    return MakeRequest<ServiceId::StopOrdersService>(body, req);
}
...
ServiceReply<V1CancelStopOrderResponse> InvestApiStopOrdersClient::StopOrdersServiceCancelStopOrder(
    ...
    std::function<pplx::task<std::shared_ptr<V1CancelStopOrderResponse>>(const StopOrdersServiceApi&, std::shared_ptr<V1CancelStopOrderRequest>)> req = &StopOrdersServiceApi::stopOrdersServiceCancelStopOrder;
    return MakeRequest<ServiceId::StopOrdersService>(body, req);
}
