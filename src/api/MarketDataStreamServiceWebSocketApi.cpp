...
MarketDataStreamServiceWebSocketApi::MarketDataStreamServiceWebSocketApi(
...
void MarketDataStreamServiceWebSocketApi::MarketDataStreamServiceMarketDataStream(
...
void MarketDataStreamServiceWebSocketApi::MarketDataStreamServiceMarketDataServerSideStream(
    ...
    if (!api_client_->config().headers().has(U("Web-Socket-Protocol"))) {
        throw ApiException(400, utility::conversions::to_string_t("MarketDataStreamServiceApi->MarketDataStreamServiceMarketDataStream does not produce any supported media type"));
    }

    if (!api_client_->config().headers().has(U("Authorization"))) {
        throw ApiException(400, utility::conversions::to_string_t("MarketDataStreamServiceApi->MarketDataStreamServiceMarketDataStream no token in  headers"));
    }
    ...
    if (status == pplx::task_group_status::canceled) {
        throw ApiException(400, utility::conversions::to_string_t("MarketDataStreamServiceApi->MarketDataStreamServiceMarketDataStream couldnt connect"));
    }
